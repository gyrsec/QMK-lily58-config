...
[_LOWER] = LAYOUT(
  ...
  _______, KC_CAPS, KC_LVM, KC_RVM, KC_CAD , _______, _______, _______, _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |   `  |SELBAK|SELWD | CTLF | CTLA | CTLR |                    |      | UNDO | REDO | SAVE |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |-------.    ,-------|      | Left | Down |  Up  |Right |RShift|
 * |------+------+------+------+------+------|  Copy |    | Paste |------+------+------+------+------+------|
